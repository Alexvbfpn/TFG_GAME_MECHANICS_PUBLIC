...
{ 
    ...
    public static class MeshUtils
    {
        ...
        static void MeshCut(Plane plane, Mesh mesh, Transform Pos)
        {
            ...
            //KEY REGION FOR THE TWO TYPES OF CUTS
        ...
        private static void CheckSideToKeep()
        {
        ...
        public static void CutByPlanes(Cuttable obj, IEnumerable<Plane> planes, bool cutCollider = true)
        {
            //MeshFilter meshFilter = obj.GetComponent<MeshFilter>() ?? obj.GetComponentInChildren<MeshFilter>();
            MeshFilter meshFilter = obj.GetComponent<MeshFilter>() ? obj.GetComponent<MeshFilter>(): obj.GetComponentInChildren<MeshFilter>();
            ...
            ConfigureMeshCollider(obj.gameObject, mesh);
            // obj.gameObject.AddComponent<MeshCollider>().sharedMesh = mesh;
            // obj.GetComponent<MeshCollider>().convex = true;
        }

        public static void ConfigureMeshCollider(GameObject obj, Mesh mesh)
        {
