...
namespace GameMechanics.EntitiesSystem
{
	public abstract class Entity : MonoBehaviour
	{
		...
		protected Action HandleControllerFunction;
		
		/// <summary>
		/// Returns the Entity Controller of this Entity.
		/// </summary>
	...
	public abstract class Entity<T> : Entity where T : Entity<T>
	{
		...
		protected virtual void InitializeController()
		{
			...
			HandleControllerFunction = HandleController;
		}
		...
		/// </summary>
		public virtual Vector3 CurrentWorldUp() => Vector3.up;
